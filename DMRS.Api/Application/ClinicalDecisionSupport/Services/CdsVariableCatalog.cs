...
namespace DMRS.Api.Application.ClinicalDecisionSupport.Services
{
    public sealed class CdsVariableCatalog : ICdsVariableCatalog
    {
        ...
        [
            ...
            new("ai.highUtilizationRisk", "boolean", "AI-predicted 30-day readmission risk (true when the model probability meets the threshold)."),
            new("ai.highUtilizationProbability", "number", "ONNX model probability of 30-day readmission when available."),
            ...
            new("ai.compositeScore", "number", "30-day readmission risk score (0–1) produced by the ONNX model."),
